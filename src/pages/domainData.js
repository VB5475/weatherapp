...
export const roadsStateData = {
  kpiData: [
    { icon: '🛣️', title: 'Total Road Length', value: '18,420', unit: ' km', change: '+312 km', trend: 'up', color: 'red' },
    { icon: '🏗️', title: 'Active Projects', value: '1,412', unit: '', change: '+48 this qtr', trend: 'up', color: 'amber' },
    { icon: '💰', title: 'Total Budget', value: '₹9,240', unit: ' Cr', change: 'FY 2024-25', trend: 'neutral', color: 'green' },
    { icon: '📊', title: 'Avg Completion', value: '67', unit: '%', change: '+4.2% MoM', trend: 'up', color: 'blue' },
...
export const roadsPanchayatData = {
  kpiData: [
    { icon: '🏘️', title: 'Village Roads', value: '42,180', unit: ' km', change: '+890 km', trend: 'up', color: 'blue' },
    { icon: '🔧', title: 'Works Sanctioned', value: '8,640', unit: '', change: 'FY 2024-25', trend: 'neutral', color: 'amber' },
    { icon: '💰', title: 'RPMS Budget', value: '₹3,420', unit: ' Cr', change: '+12% YoY', trend: 'up', color: 'blue' },
    { icon: '✅', title: 'Completion Rate', value: '58', unit: '%', change: '+3.1% QoQ', trend: 'up', color: 'green' },
  ],
...
export const buildingsStateData = {
  kpiData: [
    { icon: '🏛️', title: 'Total Projects', value: '1,800', unit: '', change: '+62 new', trend: 'up', color: 'blue' },
    { icon: '🏗️', title: 'Under Construction', value: '471', unit: '', change: 'Active', trend: 'neutral', color: 'amber' },
    { icon: '💰', title: 'Total Budget', value: '₹6,840', unit: ' Cr', change: 'FY 2024-25', trend: 'neutral', color: 'blue' },
    { icon: '📐', title: 'Floor Area Target', value: '84.2', unit: ' lakh sqft', change: '+9.4% YoY', trend: 'up', color: 'green' },
  ],
...
export const contractorRegistrationData = {
  kpiData: [
    { icon: '📋', title: 'Total Contractors', value: '14,820', unit: '', change: '+640 FY25', trend: 'up', color: 'blue' },
    { icon: '🔄', title: 'Renewals Due', value: '2,340', unit: '', change: 'Next 90d', trend: 'neutral', color: 'amber' },
    { icon: '💰', title: 'Revenue (Fees)', value: '₹48.6', unit: ' Cr', change: '+11% YoY', trend: 'up', color: 'green' },
    { icon: '⚠️', title: 'Blacklisted', value: '128', unit: '', change: 'Active ban', trend: 'down', color: 'red' },
  ],
